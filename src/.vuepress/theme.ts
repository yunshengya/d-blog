...
<img alt="备案号" src="/assets/images/beian.png" />粤ICP备2023032935号-1
</a>&nbsp;|&nbsp;主题：<a href="https://theme-hope.vuejs.press/">VuePress Theme Hope</a>&nbsp;|&nbsp;<a href="/intro">关于我的故事</a>`;

export default hopeTheme({
  hostname: "https://f9b95251.d-blog-et7.pages.dev",
  // 生成侧边栏
  sidebar: {
    "/HTML/": "structure",
  ...
  author: {
    name: "橙猫猫",
    url: "https://github.com/yunshengya",
  },
  ...
  repo: "https://github.com/yunshengya/d-blog",
  repoLabel: "GitHub",
  repoDisplay: true,
  ...
  blog: {
    description:"记录 · 思考 · 创造",
    medias: {
      GitHub: "https://github.com/yunshengya",
      // Gitee: "https://gitee.com/yunshengya",
  ...
  plugins: {
    ...
    comment: {
      ...
      provider: "Waline",
      serverURL: "https://chengmaomaoblog.vercel.app",
    },
